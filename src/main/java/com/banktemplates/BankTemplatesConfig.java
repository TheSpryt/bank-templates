...
public interface BankTemplatesConfig extends Config
{
	...
	@ConfigItem(
		...
		description = "Allow the side panel to browse, import and share templates. The community repository is a static catalogue served by Cloudflare; browsing, sharing and importing send your IP address to it.",
